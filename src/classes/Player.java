...
public class Player implements Checkable {
	...
	private static double yarn_coins, total_coin, xp = 0.0;
	private static int total_clicks = 0, level = 0;
	...
	// temporary hashmap for choosing crocheter until we learn how do choosing of
	// crocheter by clicking instead
	...
	// temporary hashmap for choosing courier until we learn how do choosing of
	// crocheter by clicking instead
	...
	// temporary method for selecting courier until we learned how to do it with
	// clicking instead
	...
	// temporary method for selecting crocheter until we learned how to do it with
	// clicking instead
	...
	public static void addCrocheters(Crocheter e) throws MaximumCrochetersException {
		if (playerCrocheters.size() == amountCrocheters)
			throw new MaximumCrochetersException();
		else
			playerCrocheters.add(e);
	}

	public static void addCourier(Courier e) throws MaximumCourierException {
		if (playerCouriers.size() >= amountCouriers)
			throw new MaximumCourierException();
		else
			playerCouriers.add(e);
	}
